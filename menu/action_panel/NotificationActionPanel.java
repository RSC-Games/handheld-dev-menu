...
public class NotificationActionPanel extends UIPanel {
    /**
     ...
     */
    public NotificationActionPanel(String message, ActionableElement actionElement) {
        super("info");
        ...
        actionElement.setText(" < OKAY >");
        actionElement.registerWithMenu(optionList);
    }
}
