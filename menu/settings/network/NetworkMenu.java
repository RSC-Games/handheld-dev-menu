...
public class NetworkMenu extends UIPanel {
    public NetworkMenu() {
        ...
        new ConnectionInfo(root, new Point(20, 70));  //   Connection Information:

        ///////////////////////////// MENU OPTIONS /////////////////////////////////
        UIElement bodyArea = new UIClip(root, new Point(0, 100), new Point(800, 480 - 15));
        MenuOptionList menu = new MenuOptionList(bodyArea, new Point(30, 80));
        new UIText(bodyArea, new Point(20, 80), ">", Color.WHITE, 12);
        new EntryEnableWiFi(menu);      // >    WiFi Enabled: Yes/No
        new EntryListNetworks(menu);    //   Registered Networks
        new EntryAddNewNetwork(menu);   //   Add New Network
    }
}
